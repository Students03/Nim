...
void Bunches::delete_chosing_stones(Logic_Nim &nim, int color_background) {
...
void Bunches::set_form_figure(Bunches::figure form) {
	Bunches::form = form;
}
